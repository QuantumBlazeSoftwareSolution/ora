...
import { LayoutDashboard, ShoppingBag, Calendar, Settings, LogOut } from 'lucide-react';
    ...
    <aside className="w-64 bg-card border-r h-screen fixed inset-y-0 left-0 hidden md:flex flex-col">
      <div className="h-16 flex items-center px-6 border-b">
         <div className="flex items-center gap-2 font-bold text-xl tracking-tight text-primary">
          <div className="w-6 h-6 bg-black rounded text-white flex items-center justify-center text-sm">O</div>
          ra.
        </div>
      </div>
